...
public class MathUtil {
    ...
    public static double[] normalise3D(final double[] p1, final double[] p2) {
        ...
        normalisedPos[0] = simplifyDouble(p2[0] - p1[0], 3);
        normalisedPos[1] = simplifyDouble(p2[1] - p1[1], 3);
        normalisedPos[2] = simplifyDouble(p2[2] - p1[2], 3);
    ...
    public static double simplifyDouble(double val, int scale) {
